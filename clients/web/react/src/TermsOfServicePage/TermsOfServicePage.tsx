...
export const TermsOfServicePagePath = "/legal/terms-of-service";
  ...
  return (
    <div className="terms-of-service-page">
      <div className="container">
        <h2>
          Terms of Service of <span className="website_name">engram</span>
        </h2>

        <p>
          <span className="website_name">engram</span> ("Us" or "We") provides
          the <span className="website_url">https://engram.xyzdigital.com</span>{" "}
          website and various related services (collectively, the "Website") to
          ...
          Service"), as well as any other written agreement between us and you.
        </p>
        ...
        <p>
          ...
          <span className="date">January 1, 2021</span>. We expressly reserve
          the right to change these Terms of Service from time to time without
        ...
        <p>
          ...
          under copyright of <span className="website_name">engram</span> or its
          ...
          <span className="website_name">engram</span> or its Affiliates.
        </p>
        ...
        <p>
          ...
          <span className="website_name">engram</span> spokesperson speaking in
        ...
        <p>
          ...
          available for use in locations outside Canada and the United States,
        ...
        <p>
          ...
          the internal laws of the <span className="country">Canada</span>{" "}
        ...
        <p>
          ...
          in the federal courts of <span className="country">Canada</span>.
        </p>
      </div>
    </div>
  );
